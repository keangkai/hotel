...
<html>
	...
	<body class="no-sidebar is-preload">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="index.html">Booking <span>Ecohotel</span>&nbsp;&nbsp;<i class="fas fa-hotel"></i></a></h1>
					<nav id="nav">
						<ul>
							<li class="current"><a href="index.html">Welcome</a></li>
							<li class="submenu">
								<a href="introduction.php">แนะนำโรงแรม</a>
								<ul>
								...
								<div class="col-xs-12 col-md-12 col-12-narrower">
                                    <section>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-2 col-md-2" style="display: flex;align-items: center;">
                                                 <a href="form.php?room_type=minisuite"><button class="btn btn-primary">Reserve</button></a>
                                            </div>
                                        </div>
                                    </section>
                                </div>
